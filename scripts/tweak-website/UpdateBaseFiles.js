...
// // ////////////////////////////////////////
 ...
 if(path.extname(filePathOutput) === '.html'){ 
  if(filePathOutput.includes("index.html")    
    || filePathOutput.includes("artifacts.html")
    || filePathOutput.includes("recent-changes.html")
    || filePathOutput.includes("toc.html")) {
