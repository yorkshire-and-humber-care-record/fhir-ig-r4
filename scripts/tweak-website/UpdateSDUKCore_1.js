...
// // ////////////////////////////////////////
 ...
 if(filePathOutput.includes("StructureDefinition-UKCore-A") 
  || filePathOutput.includes("StructureDefinition-UKCore-C")
  || filePathOutput.includes("StructureDefinition-UKCore-D")
  || filePathOutput.includes("StructureDefinition-UKCore-E")
  || filePathOutput.includes("StructureDefinition-UKCore-M")
  || filePathOutput.includes("StructureDefinition-UKCore-P")) {
