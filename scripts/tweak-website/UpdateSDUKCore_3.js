...
// // ////////////////////////////////////////
 ...
 if(path.extname(filePathOutput) === '.html'){ 
  if(filePathOutput.includes("StructureDefinition-UKCore-F") 
    || filePathOutput.includes("StructureDefinition-UKCore-H")
    || filePathOutput.includes("StructureDefinition-UKCore-L")
    || filePathOutput.includes("StructureDefinition-UKCore-Q")
    || filePathOutput.includes("StructureDefinition-UKCore-R")
    || filePathOutput.includes("StructureDefinition-UKCore-S")) {
