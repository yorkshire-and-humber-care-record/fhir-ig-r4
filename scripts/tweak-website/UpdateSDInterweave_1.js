...
// // ////////////////////////////////////////
 ...
 if(filePathOutput.includes("StructureDefinition-Interweave-A") 
  || filePathOutput.includes("StructureDefinition-Interweave-C")
  || filePathOutput.includes("StructureDefinition-Interweave-D")
  || filePathOutput.includes("StructureDefinition-Interweave-E")
  || filePathOutput.includes("StructureDefinition-Interweave-M")
  || filePathOutput.includes("StructureDefinition-Interweave-P")) {
