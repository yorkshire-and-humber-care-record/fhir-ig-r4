...
Id: Interweave-SocialCareContactReason
Title: "InterweaveSocialCareContactReason"
...
* ^date = "2024-07-15"
* ^experimental = false
* include codes from system Interweave-SocialCareContactReason
...
* ^date = "2024-07-15"
* ^experimental = false
* ^url = "https://fhir.interweavedigital.nhs.uk/CodeSystem/Interweave-SocialCareContactReason"
