...
Id: Interweave-DischargeDestination
...
Title: "InterweaveDischargeDestination"
* ^status = #draft
* ^version = "0.0.1"
* ^date = "2024-07-15"
* ^name = "InterweaveDischargeDestination"
* ^experimental = false

* include codes from system UKCore-DischargeDestinationEngland
* include codes from system Interweave-DischargeDestination
...
* ^version = "0.0.1"
* ^date = "2024-07-15"
* ^url = "https://fhir.interweavedigital.nhs.uk/CodeSystem/Interweave-DischargeDestination"
