Profile: InterweaveObservationVitalSignsHeartRate
Parent: UKCore-Observation-VitalSigns-HeartRate
Id: Interweave-Observation-VitalSigns-HeartRate
Description: "Interweave Observation Vital Signs Body Heart Rate resource profile - DRAFT."
Title: "InterweaveObservationVitalSignsHeartRate"
* ^status = #draft
* ^version = "0.0.1"
* ^date = "2024-07-15"
