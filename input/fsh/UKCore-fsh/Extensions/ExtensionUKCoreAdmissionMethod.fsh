Alias: $UKCore-AdmissionMethod = https://fhir.hl7.org.uk/ValueSet/UKCore-AdmissionMethod

Extension: ExtensionUKCoreAdmissionMethod
...
* value[x] from $UKCore-AdmissionMethod (extensible)
* value[x] ^short = "The method by which a patient was admitted to hospital"
* value[x] ^definition = "The method by which a patient was admitted to hospital."
* value[x] ^binding.description = "The method by which a patient was admitted to hospital"
