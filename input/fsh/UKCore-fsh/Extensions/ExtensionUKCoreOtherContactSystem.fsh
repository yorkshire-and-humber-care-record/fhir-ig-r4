Extension: ExtensionUKCoreOtherContactSystem
...
* value[x] from UKCore-OtherContactSystem (extensible)
* value[x] ^short = "Value for other contact system"
* value[x] ^definition = "A value to extend the system element in the ContactPoint datatype."
