...
Description: "Interweave Operation Outcome resource profile. - DRAFT"
Title: "InterweaveOperationOutcome"
* ^status = #draft
* ^version = "0.0.1"
* ^date = "2024-07-15"
...
* meta.tag[RequestId].system =  "https://fhir.interweavedigital.nhs.uk/RequestId" (exactly)
