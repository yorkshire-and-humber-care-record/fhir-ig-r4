Profile: InterweaveObservationVitalSignsBodyWeight
Parent: UKCore-Observation-VitalSigns-BodyWeight
Id: Interweave-Observation-VitalSigns-BodyWeight
Description: "Interweave Observation Vital Signs Body Weight resource profile - DRAFT."
Title: "InterweaveObservationVitalSignsBodyWeight"
* ^status = #draft
* ^version = "0.0.1"
* ^date = "2024-07-15"
...
* code.coding[loinc].display = "Body weight" (exactly)
