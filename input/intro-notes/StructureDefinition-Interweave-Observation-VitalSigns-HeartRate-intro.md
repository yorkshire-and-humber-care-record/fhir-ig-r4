...
### **Introduction**
This profile sets out the expectations for the interweave Heart rate observation resource. The base for this profile is the [UK Core Observation Vital Signs Heart Rate](https://simplifier.net/hl7fhirukcorer4/ukcore-observation-vitalsigns-heartrate). 
...
3. **code** – Fixed value of  A LOINC "magic code" describing the type of observation SHALL be present. (LOINC: 8867-4(Heart rate)). There is also a mandated set of SNOMED CT codes defined in UK Core HeartRate with preferred binding.
